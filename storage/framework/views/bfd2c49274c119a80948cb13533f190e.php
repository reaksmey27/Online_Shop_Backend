            ...
            <div class="col-md-9">
                <div class="position-relative">
                    ...
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>"
                           class="form-control rounded-3 py-2 ps-5 text-dark small" placeholder="Filter profiles by consumer name, system email hash...">
                </div>
            </div>
            <div class="col-md-3 d-flex gap-2">
                <button type="submit" class="btn btn-dark btn-sm rounded-3 w-100 fw-medium py-2">Search</button>
                <a href="<?php echo e(route('admin.users.index')); ?>" class="btn btn-light border border-light-subtle btn-sm rounded-3 w-100 fw-medium py-2 text-dark">Reset</a>
            </div>
        </form>
    </div>
</div>
