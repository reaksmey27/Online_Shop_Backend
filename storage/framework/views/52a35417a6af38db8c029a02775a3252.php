        ...
        <div class="card-body p-3">
            <form method="GET" action="<?php echo e(route('admin.orders.index')); ?>" class="row g-2 align-items-center">
                ...
                <div class="col-md-3 d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('admin.orders.index')); ?>" class="btn btn-light border border-light-subtle btn-sm rounded-3 w-100 fw-medium py-2 text-dark">Reset</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden bg-white">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border-bottom border-light-subtle">
                            <td class="px-4 py-3 fw-semibold text-dark"><?php echo e($order->id); ?></td>
                            <td class="py-3">
                                <div class="fw-semibold text-dark mb-0.5"><?php echo e($order->user->name); ?></div>
                                <div class="text-secondary small"><?php echo e($order->user->email); ?></div>
                            </td>
                            ...
                            <td class="py-3">
                                ...
                                ?>
                                <span class="badge bg-<?php echo e($statusBadge); ?> bg-opacity-10 text-<?php echo e($statusBadge); ?> px-2.5 py-1.5 rounded-pill fw-semibold" style="font-size: 0.75rem;">
                            ...
                            <td class="py-3">
                                ...
                                ?>
                                <span class="badge bg-<?php echo e($payBadge); ?> bg-opacity-10 text-<?php echo e($payBadge); ?> px-2.5 py-1.5 rounded-pill fw-semibold" style="font-size: 0.75rem;">
                            ...
                            <td class="text-end px-4 py-3">
                                <a href="<?php echo e(route('admin.orders.show', $order)); ?>" class="btn btn-sm btn-light border border-light-subtle rounded-3 text-dark px-2.5 py-1.5 fw-medium small d-inline-flex align-items-center gap-1">
        ...
        <?php if($orders->hasPages()): ?>
            <div class="card-footer bg-white border-top d-flex justify-content-between align-items-center px-4 py-3">
                <span class="text-muted small">Showing <strong><?php echo e($orders->firstItem()); ?></strong> to <strong><?php echo e($orders->lastItem()); ?></strong> of <strong><?php echo e($orders->total()); ?></strong> orders</span>
