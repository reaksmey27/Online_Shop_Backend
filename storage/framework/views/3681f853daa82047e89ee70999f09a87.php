        ...
        <table class="table align-middle mb-0">
                        ...
                        <td class="px-4 py-3">
                            <div class="d-flex align-items-center gap-3">
                                <?php if($item->product?->image_url): ?>
                                    <img src="<?php echo e($item->product->image_url); ?>" class="rounded-3"
                                ...
                                <?php endif; ?>
                                <span class="fw-semibold small" style="color:var(--text);"><?php echo e($item->product->name ?? 'Deleted product'); ?></span>
                            </div>
                        </td>
                        <td class="py-3 text-muted small">$<?php echo e(number_format($item->price, 2)); ?></td>
                        <td class="py-3 text-muted small"><?php echo e($item->quantity); ?></td>
                        <td class="fw-bold text-end px-4 py-3 small" style="color:var(--text);">$<?php echo e(number_format($item->price * $item->quantity, 2)); ?></td>
                    </tr>
            ...
            <tfoot class="table-light">
                <tr>
                    ...
                    <td class="fw-bold text-success fs-5 text-end px-4 py-3">$<?php echo e(number_format($order->total_amount, 2)); ?></td>
                </tr>
            </tfoot>
        </table>
    </div>
