    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg rounded-4 mx-auto" style="max-width:100%; width:850px;">
            <div class="modal-header border-bottom px-4 py-3">
                <h5 class="modal-title fw-bold fs-5" style="color:var(--text);">Add Product</h5>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" value="<?php echo e(old('name')); ?>" class="form-control rounded-3 py-2" placeholder="e.g. Wireless Headphones" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="row g-2 mb-3">
                                <div class="col-6">
                                    ...
                                    <input type="number" step="0.01" name="price" value="<?php echo e(old('price')); ?>" class="form-control rounded-3 py-2" placeholder="0.00" required>
                                </div>
                                <div class="col-6">
                                    <label class="form-label fw-semibold small mb-1" style="color:var(--text);">Stock <span class="text-danger">*</span></label>
                                    <input type="number" name="stock" value="<?php echo e(old('stock', 0)); ?>" class="form-control rounded-3 py-2" placeholder="0" required>
                                </div>
                            </div>
                            <div class="mb-0">
                                <label class="form-label fw-semibold small mb-1" style="color:var(--text);">Description</label>
                                <textarea name="description" rows="3" class="form-control rounded-3 py-2" placeholder="Product description…"></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <?php echo $__env->make('admin.products.partials.image-input', ['imageCtx' => 'create'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                    </div>
                    <div class="switch-surface p-3 mt-4 mb-0">
                        <div class="form-check form-switch d-flex align-items-center gap-2 ps-0 mb-0">
                            <input class="form-check-input ms-0 float-none" type="checkbox" name="is_active" id="isActiveProductCreate"
                                   style="width:2.2em; height:1.15em; cursor:pointer;" checked>
                            <label class="form-check-label fw-semibold small ms-2" for="isActiveProductCreate" style="cursor:pointer; color:var(--text);">Active</label>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\Users\REAKSMEY.SAN\Desktop\online-shop\backend\resources\views/admin/products/partials/create-modal.blade.php ENDPATH**/ ?>