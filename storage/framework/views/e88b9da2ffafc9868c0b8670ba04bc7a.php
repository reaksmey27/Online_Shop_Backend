        ...
        <form method="GET" action="<?php echo e(route('admin.categories.index')); ?>" class="row g-2 align-items-center">
            ...
            <div class="col-md-3">
                <select name="products_sort" class="form-select rounded-3 py-2 small">
                    ...
                    <option value="asc" <?php echo e(request('products_sort') === 'asc' ? 'selected' : ''); ?>>Fewer Products First</option>
                    <option value="desc" <?php echo e(request('products_sort') === 'desc' ? 'selected' : ''); ?>>More Products First</option>
                </select>
            </div>
            <div class="col-md-3 d-flex gap-2">
                <button type="submit" class="btn btn-dark btn-sm rounded-3 w-100 fw-medium py-2">Filter</button>
                <a href="<?php echo e(route('admin.categories.index')); ?>" class="btn btn-light btn-sm rounded-3 w-100 fw-medium py-2">Reset</a>
            </div>
        </form>
    </div>
</div>
<?php /**PATH C:\Users\REAKSMEY.SAN\Desktop\online-shop\backend\resources\views/admin/categories/partials/filter.blade.php ENDPATH**/ ?>