<div class="card border-0 shadow-sm rounded-4 mb-4">
    <div class="card-body p-3">
        <form method="GET" action="<?php echo e(route('admin.products.index')); ?>" class="row g-2 align-items-center">
            <div class="col-md-3">
            ...
            <div class="col-md-1">
                <input type="number" name="price_min" value="<?php echo e(request('price_min')); ?>" min="0" step="0.01"
                       class="form-control rounded-3 py-2 small" placeholder="Min $">
            </div>
            <div class="col-md-1">
                <input type="number" name="price_max" value="<?php echo e(request('price_max')); ?>" min="0" step="0.01"
            ...
            <div class="col-md-1 d-flex align-items-center justify-content-center">
                <div class="form-check">
                    <input type="checkbox" name="low_stock" value="1" id="lowStockFilter"
                           class="form-check-input" <?php echo e(request('low_stock') ? 'checked' : ''); ?>>
            ...
            <div class="col-md-2 d-flex gap-2">
                ...
                <a href="<?php echo e(route('admin.products.index')); ?>" class="btn btn-light btn-sm rounded-3 w-100 fw-medium py-2">Reset</a>
            </div>
        </form>
    </div>
</div>
<?php /**PATH C:\Users\REAKSMEY.SAN\Desktop\online-shop\backend\resources\views/admin/products/partials/filters.blade.php ENDPATH**/ ?>