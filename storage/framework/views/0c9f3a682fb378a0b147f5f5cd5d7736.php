...
unset($__errorArgs, $__bag); ?>" accept="image/*"
            onchange="previewProductFromFile(this, '<?php echo e($pfx); ?>')">
...
unset($__errorArgs, $__bag); ?>" placeholder="https://example.com/image.jpg"
            value="<?php echo e(old('image_url', isset($product) && Str::startsWith($product->image ?? '', 'http') ? $product->image : '')); ?>"
            oninput="previewProductFromUrl(this.value, '<?php echo e($pfx); ?>')">
...
<?php /**PATH C:\Users\REAKSMEY.SAN\Desktop\online-shop\backend\resources\views/admin/products/partials/image-input.blade.php ENDPATH**/ ?>