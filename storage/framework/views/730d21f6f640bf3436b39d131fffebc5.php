...
<div class="container-fluid px-2">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold text-dark mb-1">Order: 0<?php echo e($order->id); ?></h4>
            <p class="text-muted small mb-0">Review detailed ledger parameters, product allocation metrics, and logistics criteria.</p>
        </div>
        <a href="<?php echo e(route('admin.orders.index')); ?>" class="btn btn-light border border-light-subtle btn-sm rounded-3 text-dark px-3 py-2 fw-medium">
