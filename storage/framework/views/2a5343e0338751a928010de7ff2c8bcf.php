...
<head>
    ...
    <title>Admin Panel — <?php echo $__env->yieldContent('title', 'Online Shop'); ?></title>
...
<div class="d-flex w-100 h-100">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-4 bg-white border-end h-100" style="width: 260px;">
        ...
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="d-flex align-items-center mb-4 text-decoration-none text-dark gap-2">
        ...
        <form method="POST" action="<?php echo e(route('admin.logout')); ?>" class="mb-0 sidebar-nav">
            <?php echo csrf_field(); ?>
            ...
            <div class="container-fluid px-2">
                <?php if(session('success')): ?>
                    <div class="alert alert-success border-0 alert-dismissible fade show shadow-sm rounded-3 p-3 mb-4 d-flex align-items-center">
                        ...
                        <div class="text-dark fw-medium small"><?php echo e(session('success')); ?></div>
                ...
                <?php if(session('error')): ?>
                    <div class="alert alert-danger border-0 alert-dismissible fade show shadow-sm rounded-3 p-3 mb-4 d-flex align-items-center">
                        ...
                        <div class="text-dark fw-medium small"><?php echo e(session('error')); ?></div>
                        <button type="button" class="btn-close small ms-auto" data-bs-dismiss="alert"></button>
                    </div>
                <?php endif; ?>
            </div>
...
<?php /**PATH C:\Users\REAKSMEY.SAN\Desktop\online-shop\backend\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>