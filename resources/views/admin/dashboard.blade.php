            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white">
                <div class="card-body d-flex align-items-center p-4">
                    ...
                    <div>
                        ...
                        <h3 class="fw-bold text-dark mb-0">{{ number_format($totalOrders ?? 0) }}</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white">
                <div class="card-body d-flex align-items-center p-4">
                    ...
                    <div>
                        ...
                        <h3 class="fw-bold text-dark mb-0">${{ number_format($totalRevenue ?? 0, 2) }}</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 bg-white">
                <div class="card-body d-flex align-items-center p-4">
                    ...
                    <div>
                        ...
                        <h3 class="fw-bold text-dark mb-0">{{ number_format($totalProducts ?? 0) }}</h3>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        @forelse($recentOrders ?? [] as $order)
                            <tr class="border-bottom border-light-subtle">
                                <td class="px-4 py-3 text-secondary fw-medium">#{{ $order->id }}</td>
                                <td class="py-3">
                                ...
                                <td class="text-end px-4 py-3">
                                    <a href="{{ route('admin.orders.show', $order) }}" class="btn btn-sm btn-light border border-light-subtle rounded-3 fw-medium px-3 text-dark btn-hover-transition">
                                        View Details
                                    </a>
                                </td>
                            </tr>
